            ...
            <div class="box">
                <div class="box1">
                    ...
                    <form>
                        ...
                        <div class="input-container">
                            <img src={lock} alt="lock"></img>
                            <input type="confirmPassword" id="confirmPassword" name="confirmPassword" placeholder="Confirm Password" /*onChange={handleChange}*/></input>
                        </div>
                        <div class="input-container">
                        ...
                        <Link to="/login">
                            <button value="signup" onClick={handleRegister} class="signup-but">Signup</button>
                        </Link>
                    </form>
                </div>
                <div class="box2">
